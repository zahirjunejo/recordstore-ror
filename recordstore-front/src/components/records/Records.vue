<template>
  <div class="max-w-md m-auto py-10">
    ...
    <form @submit.prevent="addRecord">
      ...
      <input type="submit" value="Add Record" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-green-light hover:bg-green-dark block w-full py-4 text-white items-center justify-center">
    </form>
